        ...
        <section className="relative z-10 flex flex-col items-center justify-center px-4 pt-24 pb-16 sm:pt-38 sm:pb-28">
          <div className="w-full max-w-md text-center">
            ...
            <h1 className="text-foreground mb-4 text-4xl font-bold tracking-tight sm:text-5xl">
              Urun <span className="text-primary">Laporan</span>
            </h1>

            {/* Tagline */}
            <p className="text-muted-foreground mb-2 text-lg">Layanan Pengaduan Masyarakat</p>

            {/* Value Proposition */}
            <p className="text-muted-foreground mb-8 text-sm">
              Laporkan masalah di sekitarmu, pantau perkembangan, dan lihat transparansi tindak
              lanjut pemerintah.
            </p>
